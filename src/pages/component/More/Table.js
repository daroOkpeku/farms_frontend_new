...
export default function Table(props) {
  ...
  <tr key={key} className=''>
                <td className='flex flex-row items-center'><div className='flex flex-row items-center space-x-1'><div className='w-9'>{/*image*/}</div><p className='text-[10px] md:text-xs lg:text-xs font-medium'>{animal}</p></div> </td>
